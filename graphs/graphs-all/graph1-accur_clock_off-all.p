...
set output 'graph1-accur_clock_off-all.eps'
...
('s1nc-controlador' -0.25, 's2nc-controlador' 0.0, 's3nc-controlador' 0.25)
...
plot 'CLOCK_SYNC-ALL.out' u 24 fs pattern 4 lt -1, \
''                        u 25 fs pattern 2 lt -1, \
''                        u 26 fs pattern 7 lt -1
