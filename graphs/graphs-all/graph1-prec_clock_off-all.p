...
set output 'graph1-prec_clock_off-all.eps'
...
('s1nc-s2nc' -0.25, 's1nc-s3nc' 0.0, 's2nc-s3nc' 0.25)
...
plot 'CLOCK_SYNC-ALL.out' u 15 fs pattern 4 lt -1, \
''                        u 16 fs pattern 2 lt -1, \
''                        u 17 fs pattern 7 lt -1
